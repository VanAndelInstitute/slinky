...
# reproduce it here.  Copied verbatim from
...
# Description: Given expression data this package calculate a mulltivariate
# geometrical characterization of the differential expression and can also
# perform gene-set enrichment.  License: GPL-2
