...
For example, consider the high level method function `load`.  If 
...
`load`.  For users more familiear with the underlying data resources, 
much more granular control can be achieved through calls to the lower level 
functions including `toSummarizedExperiment`, `clue`, and 
